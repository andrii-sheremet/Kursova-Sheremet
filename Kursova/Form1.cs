...
namespace Kursova
{
    ...
    class Data
    {
        public static List<Person> data = new()
            {
                new Person( "Білоус Єлизавета Олександрівна", new(1950, 1, 1), "W", 152, new(2001, 2, 14), 3, " Мати Брат/Сестра", 1, "Опущені", "Агресивний"),
                new Person( "Гончаренко Андрій Віталійович", new(1955, 3, 15), "M", 156, new(2002, 6, 21), 5, " Брат/Сестра Шлюб Діти", 3, "Опущені", "Шістка"),
                new Person( "Кравченко Максим Володимирович", new(1960, 5, 27), "M", 185, new(2003, 11, 5), 8, " Мати Брат/Сестра", 4, "Мужики", "Спокійний"),
                new Person( "Петренко Микита Олегович", new(1965, 8, 9), "M", 152, new(2004, 4, 8), 3, " Шлюб Діти", 9, "Блатні", "Нестійкий"),
                new Person( "Шевченко Андрій Сергійович", new(1970, 10, 21), "M", 121, new(2005, 9, 13), 8, " Шлюб Діти", 2, "Мужики", "Агресивний"),
                new Person( "Кравченко Дмитро Сергійович", new(1975, 12, 3), "M", 125, new(2006, 12, 22), 3, " Мати Брат/Сестра", 3, "Опущені", "Нестійкий"),
                new Person( "Ковальчук Наталія Миколаївна", new(1980, 2, 14), "W", 115, new(2007, 8, 7), 15, " Шлюб Діти", 8, "Блатні", "Нестійкий"),
                ...
                new Person( "Петренко Олег Віталійович", new(1992, 11, 1), "M", 185, new(2011, 3, 12), 8, " Мати Шлюб", 10, "Опущені", "Нестійкий"),
                new Person( "Петренко Ігор Володимирович", new(1951, 2, 12), "M", 125, new(2012, 7, 23), 3, " Брат/Сестра Шлюб Діти", 6, "Козли", "Спокійний"),
                new Person( "Сидоренко Дмитро Сергійович", new(1956, 4, 24), "M", 121, new(2013, 12, 3), 8, " Мати Брат/Сестра", 9, "Мужики", "Шістка"),
                ...
                new Person( "Ковальчук Дмитро Олександрович", new(1971, 11, 29), "M", 156, new(2016, 6, 8), 5, " Мати Батько Діти", 8, "Козли", "Нестійкий"),
                new Person( "Харченко Юлія Іванівна", new(1976, 1, 10), "W", 121, new(2017, 10, 19), 8, " Батько", 9, "Блатні", "Спокійний"),
                new Person( "Царенко Анна Віталіївна", new(1981, 3, 23), "W", 122, new(2018, 5, 2), 3, " Мати Шлюб", 10, "Заполоскані", "Нестійкий"),
                new Person( "Лисенко Олександр Миколайович", new(1986, 6, 4), "M", 125, new(2019, 11, 14), 3, " Мати Батько Діти", 10, "Козли", "Шістка"),
                new Person( "Шевченко Денис Васильович", new(1993, 8, 16), "M", 122, new(2020, 3, 26), 3, " Мати Шлюб", 1, "Заполоскані", "Агресивний")
            };
    }
